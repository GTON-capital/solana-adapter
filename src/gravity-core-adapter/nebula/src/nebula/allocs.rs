...
pub fn allocation_by_instruction_index(instruction: usize, oracles_bft: Option<usize>) -> Result<Vec<usize>, NebulaError> {
    Ok(match instruction {
        ...
        // SendHashValue
        2 => {
            vec![NebulaContractInstruction::DATA_HASH_ALLOC]
        },
        // SendValueToSubs
        3 => {
            vec![
        ...
        // Subscribe
        4 => {
            vec![NebulaContractInstruction::PUBKEY_ALLOC, 1, 8]
        },
